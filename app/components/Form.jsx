...
const Form = () => {
	...
	return (
		<div
			...
			style={{
				backgroundImage: "url('/assets/img/renders/Master_Bedroom.png')",
			}}
		>
			...
			<AnimatePresence mode="wait">
				<motion.div
					key={language} // Use language as the key to trigger animation on change
					initial={{ y: 100, opacity: 0 }}
					animate={{ y: 0, opacity: 1 }}
					exit={{ y: -100, opacity: 0 }}
					transition={{ duration: 0.5, ease: "easeOut" }}
					className="relative z-10 flex w-full flex-col md:flex-row"
				>
					{/* LEFT INFO */}
					<div className="hidden md:flex w-1/2 items-start justify-center text-white relative">
						<div className="md:pt-[120px] p-8 w-full">
							<div className="absolute top-0 right-0 h-[calc(95%-90px)] mt-20 w-px bg-white opacity-30" />
							<div className="text-center space-y-6 max-w-sm mx-auto">
								...
								<div className="space-y-2">
									<div className="flex items-center justify-start pl-14 space-x-3">
										<svg
					...
					{/* RIGHT FORM */}
					<div className="w-full md:w-1/2 flex items-start justify-center text-white">
						<div className="pt-[120px] md:pt-[120px] p-6 w-full">
							<div className="w-full max-w-lg space-y-6 mx-auto">
								{!submitted ? (
									<form onSubmit={handleSubmit} className="space-y-6">
										...
										<div>
											...
											<input
												...
												className="w-full border border-gray-400 p-2 rounded-md text-white placeholder-gray-400 bg-transparent"
											/>
										</div>
										...
										<button
											type="submit"
											className="w-full font-bold uppercase bg-white text-black py-2 px-4 rounded-md hover:bg-gray-300 transition"
										>
											{t.submitButton}
										</button>
									</form>
									...
									<div className="text-center">
										...
										<p className="text-l">{t.successMessage}</p>
									</div>
								)}
							</div>
						</div>
